...
public class ZnajdzPierwiastki extends JFrame implements ActionListener
{
	...
	private JTextField aField, bField, cField, deltaField, x1Field, x2Field; //zmienne typu JTextField
	private JLabel napisGlowny, napisA, napisB, napisC, napisDelta; //zmienne typu JLabel
	private JButton obliczButton; //zmienna typu JButton
	private double a, b, c, delta, pierDelta, x1, x2; //zmienne typu double
